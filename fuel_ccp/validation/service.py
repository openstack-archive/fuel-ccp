...
from validation import base as validation_base
...
def validate_services(components_map, components):
    ...
    for component in components:
        try:
            ...
            LOG.error("Validation for component %s is not passed.", component)
            raise e

    LOG.info("Validation of services for components %s passed successfully!",
             components)

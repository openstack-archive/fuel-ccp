...
class TestAddress(testscenarios.WithScenarios, base.TestCase):
    scenarios = (
        ('internal_without_port', {'address': 'service.ccp.cluster.local'}),
        ('internal_with_port', {'address': 'service.ccp.cluster.local:1234',
                                'port': {'cont': 1234}}),
        ...
        ('external_without_ingress_and_nodeport',
         {'address': 'service.ccp.cluster.local:1234', 'external': True,
        ...
        ('internal_with_scheme',
            {'address': 'http://service.ccp.cluster.local',
             'with_scheme': True}),

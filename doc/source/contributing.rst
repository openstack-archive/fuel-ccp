...
#. Please follow OpenStack `Gerrit Workflow`_ to to contribute to CCP.
...
- Please refer to :doc:`docker`, while making chages to Docker files.

- Please refer to :doc:`app_def_guide`, while making chages to ``service/*``
  files.

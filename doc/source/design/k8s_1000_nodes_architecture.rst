...
In the proposed architecture, there is a single pod for Proxy Server
under control of Kubernetes. The pod is defined as a ReplicationController
with just one replica. The proxy server exposes Kubernetes API
externally.
...
Scaling Kubernetes cluster to about 1000 nodes requires certain
...
default value (3s) to more appropriate value of 10 minutes (10m)::

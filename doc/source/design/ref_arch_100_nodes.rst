...
==============================================
OpenStack Reference Architecture For 100 Nodes
==============================================

This document proposes a new Reference Architecture (RA) of OpenStack
installation on top of Kubernetes that supports a number of 100
...
3 instances of Keystone at the scale of 100 nodes. Load balancer
...
nodes to run Keystone service is 3. However, instances of Keystone can
share these nodes with any other services.
...
it is possible at scale of 100 nodes. See below for recommendations on
scaling Horizon.
...
At the scale of 1 hundred of nodes 3 instances of Scheduler will suffice.
